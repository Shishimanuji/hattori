-- Database Schema Redesign Migration Part 3 (Final)
-- Completes the migration of existing tables
...
-- ============================================================================
-- 8. REPORT TEMPLATES TABLE - Reusable report configurations
-- ============================================================================
DO $$ BEGIN
...
CREATE INDEX IF NOT EXISTS idx_project_summary_project_id ON project_summary(project_id);

CREATE INDEX IF NOT EXISTS idx_assets_project_id ON assets(project_id);
CREATE INDEX IF NOT EXISTS idx_assets_resource_type_id ON assets(resource_type_id);
CREATE INDEX IF NOT EXISTS idx_assets_asset_code ON assets(asset_code);
CREATE INDEX IF NOT EXISTS idx_assets_serial_number ON assets(serial_number);
CREATE INDEX IF NOT EXISTS idx_assets_status ON assets(status);
CREATE INDEX IF NOT EXISTS idx_assets_audit_status ON assets(audit_status);
CREATE INDEX IF NOT EXISTS idx_assets_custodian_id ON assets(custodian_id);
CREATE INDEX IF NOT EXISTS idx_assets_warranty_end ON assets(warranty_end);
CREATE INDEX IF NOT EXISTS idx_assets_created_by ON assets(created_by);

CREATE INDEX IF NOT EXISTS idx_asset_field_values_asset_id ON asset_field_values(asset_id);
CREATE INDEX IF NOT EXISTS idx_asset_field_values_field_id ON asset_field_values(resource_field_id);
